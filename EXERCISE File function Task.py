...
# def sum_two(a,b):
#     return a+b
# print(f"Sum of 3 and 4 is {sum_two(3,4)}")
...
# def multiply(a,b=2):
#     return a*b
# print(f"The inputting 3 gives product {multiply(3)}")
# print(f"The inputting 3 and 5 gives product {multiply(3,5)}")
...
# def power(a,b=2):
#     return a**b
# print(f"3 raised to default value of b is {power(3)}")
# print(f"3 raised to 3 is {power(3,3)}")
...
# f.write("New Delhi, Tokyo, Ottawa, Canberra, Berlin")
# f.close()
...
the screen.
# '''
# user_input = input("Enter a capital city of your choice:>>")
